...
(function()
{
  ...
  { 
    ...
    Lopt.value = '-';
    Lopt.innerHTML = util['getOption']('unmappedKeyboardName','English');
    ui.KeyboardSelector.appendChild(Lopt);  
    Lopt = null;

    // Check required interface alignment
    var opt=util['getOption']('ui');
    if(typeof(opt) == 'object' && typeof(opt['position']) != 'undefined')
      ui.floatRight = (opt['position']=='right');
