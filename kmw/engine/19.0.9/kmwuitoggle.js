...
`}createMenu(){typeof this.keyboardMenu=="undefined"?(this.keyboardMenu=a.createElement("ul"),this.keyboardMenu.id="KeymanWeb_KbdList",this.keyboardMenu.className="sfunhover"):this.keyboardMenu.innerHTML="";var e=a.createElement("li"),t=a.createElement("a");t.innerHTML="(System keyboard)",t.href="#",t.onclick=()=>this.selectKbd(-1),t.id="KMWSel_$",t.className="selected",e.appendChild(t),this.selectedMenuItem=t,this.keyboardMenu.appendChild(e);let s=i.getKeyboards(),o={};this.keyboards=[];for(var n=0;n<s.length;n++){var d=a.createElement("li"),u=a.createElement("a");u.innerHTML=s[n].LanguageName+" - "+s[n].Name,o[s[n].InternalName]||(o[s[n].InternalName]=0),o[s[n].InternalName]++;var l=o[s[n].InternalName];this.keyboards.push({_InternalName:s[n].InternalName,_LanguageCode:s[n].LanguageCode,_Index:l}),u.href="#",u.onclick=(r=>()=>this.selectKbd(r))(this.keyboards.length-1),u.id="KMWSel_"+s[n].InternalName+"$"+l,d.appendChild(u),this.keyboardMenu.appendChild(d)}this.keyboardMenu.parentNode!=this.kbdButton.getElem()&&this.kbdButton.getElem().appendChild(this.keyboardMenu)}};y(m,"ToggleUI");let b=m,h=i.ui=new b;i.addHotKey(191,32,h.switchSingleKbd),i.addHotKey(191,48,h.switchNextKbd),i.addHotKey(191,64,h.switchOsk),i.addEventListener("controlfocused",function(c){h.doFocus(c.target,!0,c.activeControl)}),i.addEventListener("controlblurred",function(c){h.doFocus(c.target,!1,null)}),i.addEventListener("keyboardregistered",function(c){h.updateList=!0,h.updateTimer&&clearTimeout(h.updateTimer),h.updateTimer=window.setTimeout(h.updateKeyboardList,200)}),i.addEventListener("keyboardchange",function(c){h.updateMenu(c.internalName,c.languageCode)}),h.initialize()}catch(i){}})();
